...
{    //Importation du tree donnée test beam
    ...
    TCut posy0 = "Ytr[0]*18.5*1e-3 <= (1.967+0.51) &&  Ytr[0]*18.5*1e-3 >= (1.967-0.51)";
    TCut posy1 = "Ytr[1]*18.5*1e-3 <= (2.779+0.6) &&  Ytr[1]*18.5*1e-3 >= (2.779-0.6)";
    TCut posx0 = "Xtr[0]*18.5*1e-3 <= (10.52+0.51) &&  Xtr[0]*18.5*1e-3 >= (10.52-0.51)";
    ...
    TH2F *h = new TH2F("h","Xtrace vs YTrace DUT[0]",70,515,620,70,53,158);
    h-> SetYTitle("y in mm");
    h-> SetXTitle("x in mm");
    ...
    tree->Draw("Ytr[0]:Xtr[0]>>h",pulse && time0 && posx0 && posy0,"Colz");
    ScaleXaxis(h,ScaleX);
    ScaleYaxis(h,ScaleY);
    ...
    TH2F *h1 = new TH2F("h1","Xtrace vs YTrace DUT[1]",70,535,635,70,100,200);
    ...
    tree->Draw("Ytr[1]:Xtr[1]>>h1",pulse && time1 && posx1 && posy1,"Colz");
    ScaleXaxis(h1,ScaleX);
    ScaleYaxis(h1,ScaleY);
    
    c3->Print("fig/XtrYtrZoomCut.png");
