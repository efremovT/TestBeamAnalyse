...
{    //Importation du tree donnée test beam
    ...
    TH2F *h = new TH2F("h","DUT[0] With first peak cut",100,465,670,100,-3,208);
    h-> SetYTitle("y in mm");
    h-> SetXTitle("x in mm");
    ...
    tree->Draw("Ytr[0]:Xtr[0]>>h",pulse && time0 && Charge,"Colz");
    ScaleXaxis(h,ScaleX);
    ScaleYaxis(h,ScaleY);
    
    
    
    c3->Print("fig/XtrYtrZoomChargeVerif.png");
