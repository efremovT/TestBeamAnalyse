...
{    //Importation du tree donnée test beam
    ...
    TCut time0 = "((timeCFD20[2]-timeCFD50[0]) > 0 && (timeCFD20[2]-timeCFD50[0]) < 2000)";
    TCut time1 = "((timeCFD20[2]-timeCFD50[1]) > 0 && (timeCFD20[2]-timeCFD50[1]) < 2000)";
    TCut Charge= "charge[0] >= -5 && charge[0] <= 5";
    ...
    TH1F *h = new TH1F("h","charge of FBK_W19 DUT[0] first peak cut ",100,-5,50);
    h -> SetLineColor(8);
    h-> SetFillColor(8);
    h-> SetFillStyle(3001);
    h-> SetLineWidth(2);
    ...
    tree->Draw("charge[0]>>h",pulse && time0 && Charge);
    ...
    TH2F *h1 = new TH2F("h1","DUT[0] first peak cut",100,465,670,100,-3,208);
    ...
    tree->Draw("Ytr[0]:Xtr[0]>>h1",pulse && time0 && Charge,"Colz");
    ...
    TH1F *h2 = new TH1F("h2","charge of FBK_W19 DUT[0] without first peak",100,-5,50);
    h2 -> SetLineColor(8);
    h2-> SetFillColor(8);
    ...
    tree->Draw("charge[0]>>h2",pulse && time0 && "charge[0] >= 5");
    
    h2-> Fit("landau","RL","",5,50);
    ...
    TH2F *h3 = new TH2F("h3","DUT[0] without first peak",100,465,670,100,-3,208);
    ...
    tree->Draw("Ytr[0]:Xtr[0]>>h3",pulse && time0 && "charge[0] >= 5","Colz");
    ...
    TH1F *h4 = new TH1F("h4","charge of FBK_W19 DUT[0] Geometric Cut on the Pad",100,-5,50);
    h4 -> SetLineColor(8);
    h4-> SetFillColor(8);
    ...
    tree->Draw("charge[0]>>h4",pulse && time0 && posx0 && posy0);
    
    h4-> Fit("landau","RL","",5,50);
    ...
    TH2F *h5 = new TH2F("h5","DUT[0] Geometric Cut on the Pad",100,465,670,100,-3,208);
    ...
    tree->Draw("Ytr[0]:Xtr[0]>>h5",pulse && time0 && posx0 && posy0,"Colz");
    ...
    newpad->Draw();
    newpad->cd();
    TPaveText *title = new TPaveText(0.85,0.62,0.98,0.72) ;
    title -> AddText("1mm cut");
    title->SetFillColor(16);
    title->SetTextFont(70);
    title->SetTextSize(0.019);
    title->Draw();
    
    TPaveText *title1 = new TPaveText(0.2,0.62,0.35,0.72) ;
    title1 -> AddText("Q < 5fC");
    title1->SetFillColor(16);
    title1->SetTextFont(70);
    title1->SetTextSize(0.020);
    title1->Draw();
    
    TPaveText *title2 = new TPaveText(0.52,0.62,0.67,0.72) ;
    title2 -> AddText("Q > 5fC");
    title2->SetFillColor(16);
    title2->SetTextFont(70);
    title2->SetTextSize(0.020);
    title2->Draw();
    
    
    TLatex *tex = new TLatex(0.3,0.5,"All data is cut on SiPM Pulse height and TimeCFD20[SiPM]-TimeCFD50[DUT]");
    tex->SetNDC();
    tex->SetTextSize(0.02);
    tex->Draw();
    
    c3->Print("fig/FullAnalysisDUT0CFD.png");
