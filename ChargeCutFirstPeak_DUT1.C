...
{    //Importation du tree donnée test beam
    ...
    TCut time0 = "((timeAtMax[2]-timeAtMax[1]) > 3000 && (timeAtMax[2]-timeAtMax[1]) < 5000)";
    TCut Charge2= "charge[1] <= 2";
    TCut Charge3= "charge[1] <= 3";
    TCut Charge4= "charge[1] <= 4";
    TCut Charge5= "charge[1] <= 5";
    ...
    TH1F *h = new TH1F("h","charge of IMEv2_W7Q2 DUT[1] Q<2 ",100,-5,50);
    h -> SetLineColor(4);
    h-> SetFillColor(4);
    h-> SetFillStyle(3001);
    h-> SetLineWidth(2);
    ...
    tree->Draw("charge[1]>>h",pulse && time0 && Charge2);
    ...
    TH2F *h1 = new TH2F("h1","DUT[1] Q<2",100,485,685,100,50,250);
    ...
    tree->Draw("Ytr[1]:Xtr[1]>>h1",pulse && time0 && Charge2,"Colz");
    ...
    TH1F *h2 = new TH1F("h2","charge of IMEv2_W7Q2 DUT[1] Q<3 ",100,-5,50);
    h2 -> SetLineColor(4);
    h2-> SetFillColor(4);
    ...
    tree->Draw("charge[1]>>h2",pulse && time0 && Charge3);
    ...
    TH2F *h3 = new TH2F("h3","DUT[1] Q<3",100,485,685,100,50,250);
    ...
    tree->Draw("Ytr[1]:Xtr[1]>>h3",pulse && time0 && Charge3,"Colz");
    ...
    TH1F *h4 = new TH1F("h4","charge of IMEv2_W7Q2 DUT[1] Q<4 ",100,-5,50);
    h4 -> SetLineColor(4);
    h4-> SetFillColor(4);
    ...
    tree->Draw("charge[1]>>h4",pulse && time0 && Charge4);
    ...
    TH2F *h5 = new TH2F("h5","DUT[1] Q<4",100,485,685,100,50,250);
    ...
    tree->Draw("Ytr[1]:Xtr[1]>>h5",pulse && time0 && Charge4,"Colz");
    ...
    TH1F *h6 = new TH1F("h6","charge of IMEv2_W7Q2 DUT[1] Q<5 ",100,-5,50);
    h6 -> SetLineColor(4);
    h6-> SetFillColor(4);
    h6-> SetFillStyle(3001);
    h6-> SetLineWidth(2);
    h6->SetYTitle("Number of event");
    h6->SetXTitle("Charge in fC");
    h6->SetTitleSize(0.042,"x");
    h6->SetTitleSize(0.042,"y");
    h6->SetStats();
    
    tree->Draw("charge[1]>>h6",pulse && time0 && Charge5);
    ...
    TH2F *h7 = new TH2F("h7","DUT[1] Q<5",100,485,685,100,50,250);
    h7-> SetYTitle("y in mm");
    h7-> SetXTitle("x in mm");
    h7-> SetTitleSize(0.042,"x in mm");
    h7-> SetTitleSize(0.042,"y in mm");
    h7-> SetZTitle("Events");
    h7-> SetStats();
    h7-> SetMinimum(2);
    h7-> GetZaxis()->SetNdivisions(-507,kTRUE);
    h7-> GetZaxis()->SetMaxDigits(3);
    
    tree->Draw("Ytr[1]:Xtr[1]>>h7",pulse && time0 && Charge5,"Colz");
    ScaleXaxis(h7,ScaleX);
    ScaleYaxis(h7,ScaleY);
    ...
    c3->Print("fig/ChargeCutFirstPeakDUT1.png");
