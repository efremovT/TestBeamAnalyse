...
{    //Importation du tree donnée test beam
    ...
    TCut posx08 = "Xtr[1]*18.5*1e-3 <= (10.82+0.4) &&  Xtr[1]*18.5*1e-3 >= (10.82-0.4)";
    TCut posy08 = "Ytr[1]*18.5*1e-3 <= (2.779+0.4) &&  Ytr[1]*18.5*1e-3 >= (2.779-0.4)";
    TCut posx05 = "Xtr[1]*18.5*1e-3 <= (10.82+0.25) &&  Xtr[1]*18.5*1e-3 >= (10.82-0.25)";
    TCut posy05 = "Ytr[1]*18.5*1e-3 <= (2.779+0.25) &&  Ytr[1]*18.5*1e-3 >= (2.779-0.25)";
    ...
    TH1F *h = new TH1F("h","charge of IMEv2_W7Q2 DUT[1] 1.2mm cut ",100,-5,50);
    h -> SetLineColor(4);
    h-> SetFillColor(4);
    h-> SetFillStyle(3001);
    h-> SetLineWidth(2);
    ...
    tree->Draw("charge[1]>>h",pulse && time0 && posx1 && posy1);
    ...
    TH2F *h1 = new TH2F("h1","DUT[1] 1.2mm cut",100,485,685,100,50,250);
    ...
    tree->Draw("Ytr[1]:Xtr[1]>>h1",pulse && time0 && posx1 && posy1,"Colz");
    ...
    TH1F *h2 = new TH1F("h2","charge of IMEv2_W7Q2 DUT[1] 0.8mm cut ",100,-5,50);
    h2 -> SetLineColor(4);
    h2-> SetFillColor(4);
    ...
    tree->Draw("charge[1]>>h2",pulse && time0 && posx08 && posy08);
    
    h2-> Fit("landau","R","",-5,50);
    ...
    TH2F *h3 = new TH2F("h3","DUT[1] 0.8mm cut",100,485,685,100,50,250);
    ...
    tree->Draw("Ytr[1]:Xtr[1]>>h3",pulse && time0 && posx08 && posy08,"Colz");
    ...
    TH1F *h4 = new TH1F("h4","charge of IMEv2_W7Q2 DUT[1] 0.5mm cut ",100,-5,50);
    h4 -> SetLineColor(4);
    h4-> SetFillColor(4);
    ...
    tree->Draw("charge[1]>>h4",pulse && time0 && posx05 && posy05);
    
    h4-> Fit("landau","R","",-5,50);
    ...
    TH2F *h5 = new TH2F("h5","DUT[1] 0.5mm cut",100,485,685,100,50,250);
    ...
    tree->Draw("Ytr[1]:Xtr[1]>>h5",pulse && time0 && posx05 && posy05,"Colz");
