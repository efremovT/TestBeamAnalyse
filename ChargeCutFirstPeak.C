...
{    //Importation du tree donnée test beam
    ...
    TCut Charge2= "charge[0] <= 2";
    TCut Charge3= "charge[0] <= 3";
    TCut Charge4= "charge[0] <= 4";
    TCut Charge5= "charge[0] <= 5";
    ...
    TH1F *h = new TH1F("h","charge of FBK_W19 DUT[0] Q<2 ",100,-5,50);
    h -> SetLineColor(2);
    h-> SetFillColor(2);
    h-> SetFillStyle(3001);
    h-> SetLineWidth(2);
    ...
    tree->Draw("charge[0]>>h",pulse && time0 && Charge2);
    ...
    TH2F *h1 = new TH2F("h1","DUT[0] Q<2",100,465,670,100,-3,208);
    ...
    tree->Draw("Ytr[0]:Xtr[0]>>h1",pulse && time0 && Charge2,"Colz");
    ...
    TH1F *h2 = new TH1F("h2","charge of FBK_W19 DUT[0] Q<3 ",100,-5,50);
    h2 -> SetLineColor(2);
    h2-> SetFillColor(2);
    ...
    tree->Draw("charge[0]>>h2",pulse && time0 && Charge3);
    ...
    TH2F *h3 = new TH2F("h3","DUT[0] Q<3",100,465,670,100,-3,208);
    ...
    tree->Draw("Ytr[0]:Xtr[0]>>h3",pulse && time0 && Charge3,"Colz");
    ...
    TH1F *h4 = new TH1F("h4","charge of FBK_W19 DUT[0] Q<4 ",100,-5,50);
    h4 -> SetLineColor(2);
    h4-> SetFillColor(2);
    ...
    tree->Draw("charge[0]>>h4",pulse && time0 && Charge4);
    ...
    TH2F *h5 = new TH2F("h5","DUT[0] Q<4",100,465,670,100,-3,208);
    ...
    tree->Draw("Ytr[0]:Xtr[0]>>h5",pulse && time0 && Charge4,"Colz");
    ...
    TH1F *h6 = new TH1F("h6","charge of FBK_W19 DUT[0] Q<5 ",100,-5,50);
    h6 -> SetLineColor(2);
    h6-> SetFillColor(2);
    ...
    tree->Draw("charge[0]>>h6",pulse && time0 && Charge5);
    ...
    TH2F *h7 = new TH2F("h7","DUT[0] Q<5",100,465,670,100,-3,208);
    ...
    tree->Draw("Ytr[0]:Xtr[0]>>h7",pulse && time0 && Charge5,"Colz");
    ...
    c3->Print("fig/ChargeCutFirstPeakDUT0.png");
